...
export class TestContainersService extends BaseService {
  ...
  async buildVirtualClos(config?: { spines?: number; leaves?: number; region_id?: string; campus_id?: string; datacenter_id?: string; halls?: number; rows_per_hall?: number; racks_per_row?: number; leaves_per_rack?: number; external_devices?: number; uplinks_per_spine?: number; external_names?: string[]; spawn_containers?: boolean; ceos_image?: string }): Promise<ClosLabResponse> {
