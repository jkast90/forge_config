...
/** Returns a spinner when loading, otherwise the named icon. Useful for table action buttons. */
export function loadingIcon(isLoading: boolean, name: string, size = 14) {
  return isLoading ? <SpinnerIcon size={size} /> : <Icon name={name} size={size} />;
}
